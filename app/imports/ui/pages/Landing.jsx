    ...
    return (
        ...
        <Grid container stackable centered columns={3} >
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h3' inverted>Each time you make contact with a contact, you can write a note that summarizes the converstation. This note is saved along with a timestamp with the contact.</Header>
          </Grid.Column>
